...
const september28 = () => {
    ...
    /*---- scroll messages ----*/
    tlMessages1
        .from(messages[1], animationSpeak);
    ...
    for (let i = 12; i < 16; i++) {
        tlMessages3.from(messages[i], animationMessage);
    }
...
const june9 = () => {
    ...
    let conversationHeightKatrijn = gsap.getProperty($conversationKatrijn, 'height') - 105;
    ...
    tlJune9
        .to($conversationSiebe, animationConversation(conversationHeightSiebe, $messagesSiebe, 0))
        .to($messagesSiebe[0], animationMessage)
        .to($conversationKatrijn, animationConversation(conversationHeightKatrijn, $messagesKatrijn, 0), ">-1.5")
        .to($messagesKatrijn[0], animationMessage, ">")
        .to($conversationSilke, animationConversation(conversationHeightSilke, $messagesSilke, 0), ">-1.5")
        .to($messagesSilke[0], animationMessage, ">")
        .to($conversationKatrijn, animationConversation(conversationHeightKatrijn, $messagesKatrijn, 1), ">-0.3")
        .to($messagesKatrijn[1], animationMessage, ">")
        .to($conversationKatrijn, animationConversation(conversationHeightKatrijn, $messagesKatrijn, 2))
        .to($messagesKatrijn[2], animationMessage)
        .to($conversationSilke, animationConversation(conversationHeightSilke, $messagesSilke, 1), ">-1.8")
        .to($messagesSilke[1], animationMessage, ">")
        .to($conversationKatrijn, animationConversation(conversationHeightKatrijn, $messagesKatrijn, 3))
        .to($messagesKatrijn[3], animationMessage)
        .to($conversationKatrijn, animationConversation(conversationHeightKatrijn, $messagesKatrijn, 4))
        .to($messagesKatrijn[4], animationMessage)
        .to($conversationSiebe, animationConversation(conversationHeightSiebe, $messagesSiebe, 1), ">-1.5")
        .to($messagesSiebe[1], animationMessage, ">")
        .to($conversationSilke, animationConversation(conversationHeightSilke, $messagesSilke, 2), ">-1")
        .to($messagesSilke[2], animationMessage, ">")
        .to($conversationSiebe, animationConversation(conversationHeightSiebe, $messagesSiebe, 2), ">-1.5")
        .to($messagesSiebe[2], animationMessage, ">")
        .to($conversationSilke, animationConversation(conversationHeightSilke, $messagesSilke, 3), ">-1")
        .to($messagesSilke[3], animationMessage, ">")
        .to($conversationKatrijn, animationConversation(conversationHeightKatrijn, $messagesKatrijn, 5))
        .to($messagesKatrijn[5], animationMessage)
}


const animationConversation = (conversationHeight, messages, index) => {
    let height = conversationHeight
    for (let i = 0; i < index + 1; i++) {
        height = height - (gsap.getProperty(messages[i], 'height')) - 40;
    }
...
/*----------------------- END -----------------------*/
    ...
    const imagesEndLeft = document.querySelector(".end__images--left");
    const imagesEndRight = document.querySelector(".end__images--right");

    gsap.set(imagesEndLeft, {
        yPercent: -36.5,
    })

    gsap.set(imagesEndRight, {
        yPercent: -6.5,
    })

    gsap.to(imagesEndRight, {
        duration: 55,
        repeat: -1,
        yoyo: true,
        yPercent: -36.5,
